---
title: "第 05 章：Context Engineering——Runtime Context、Graph State 与 Store"
description: "按生命周期与控制权区分 Runtime Context、Graph State、Store 和 Secret。"
...
继续阅读：[第 06 章：把横切规则装入 Agent 生命周期](/langchain-logbook/posts/06_observability_persistence/)。