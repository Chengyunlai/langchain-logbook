---
title: "第 00 章：先看懂模型、Chain、Agent 和 LangGraph"
description: "建立模型调用、固定管道、Agent 循环和显式 Graph 的初学者坐标系。"
pubDatetime: 2026-04-03T13:00:00Z
featured: false
tags: ["tutorial"]
sourcePath: "ORIENTATION.md"
learningOrder: 0
learningStage: "orientation"
learningStageTitle: "先建立坐标，再接手研究交付任务"
learningGoal: "建立模型调用、固定管道、Agent 循环和显式 Graph 的初学者坐标系。"
contentType: "main"
---
...
先读[课程序章](/langchain-logbook/)，接手贯穿全书的研究交付任务。然后进入[第 01 章](/langchain-logbook/posts/01_getting_started/)，实际调用模型并检查 Message 的输入与返回值。